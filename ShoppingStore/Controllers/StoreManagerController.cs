...
{
    [Authorize (Users ="keepitsimple@Peoplecert.com")]
    public class StoreManagerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemId,CategoryId,ProducerId,Title,Description,Price,ItemArtUrl")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemId,CategoryId,ProducerId,Title,Description,Price,ItemArtUrl")] Item item)
        {
            if (ModelState.IsValid)
            {
